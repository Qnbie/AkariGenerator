...
namespace Utils.TestData
{
    public class TestPuzzleNormal
    {
        ...
        {
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Empty,TileStates.Lamp      ,TileStates.Empty     ,TileStates.Wall,TileStates.Empty,TileStates.Lamp,TileStates.Empty,TileStates.Empty},
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Lamp ,TileStates.Three     ,TileStates.Lamp      ,TileStates.Wall,TileStates.Lamp,TileStates.Four,TileStates.Lamp,TileStates.Empty},
            new List<TileStates>() {TileStates.Empty,TileStates.Wall ,TileStates.Empty,TileStates.Wall      ,TileStates.Empty     ,TileStates.Empty,TileStates.Wall,TileStates.Lamp,TileStates.Empty,TileStates.Empty},
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Wall ,TileStates.Empty     ,TileStates.Empty     ,TileStates.Empty,TileStates.Lamp,TileStates.Three,TileStates.Wall,TileStates.Empty},
            new List<TileStates>() {TileStates.Wall ,TileStates.Zero ,TileStates.Empty,TileStates.Empty     ,TileStates.Empty     ,TileStates.Empty,TileStates.Empty,TileStates.Lamp,TileStates.Empty,TileStates.Empty},
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Empty,TileStates.Empty     ,TileStates.Empty     ,TileStates.Empty,TileStates.Empty,TileStates.Empty,TileStates.Wall,TileStates.Wall},
            new List<TileStates>() {TileStates.Empty,TileStates.Wall ,TileStates.Wall ,TileStates.Empty     ,TileStates.Empty     ,TileStates.Empty,TileStates.Empty,TileStates.Two,TileStates.Empty,TileStates.Empty},
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Empty,TileStates.One       ,TileStates.Implacable,TileStates.Empty,TileStates.Two,TileStates.Empty,TileStates.Two,TileStates.Empty},
            ...
            new List<TileStates>() {TileStates.Empty,TileStates.Empty,TileStates.Empty,TileStates.Empty     ,TileStates.Implacable,TileStates.Empty,TileStates.Implacable,TileStates.Empty,TileStates.Empty,TileStates.Empty}
        }, Difficulty.Medium);
